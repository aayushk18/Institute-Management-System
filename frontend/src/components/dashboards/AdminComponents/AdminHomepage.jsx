    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const value = await getResponse();
                setValue(value)
                console.log(value);

                setTotalPerson(prev => ({
                    ...prev,
                    TotalStudents: value.totalStudent,
                    TotalTeachers: value.totalTeachers,
                    TotalEmployees: value.totalTeachers + value.totalStaff,
                }));

                setGenderData([
                    { name: 'Boys', value: value.male },
                    { name: 'Girls', value: value.female }
                ]);
        ...
        <div className=" p-5 space-y-6">
            ...
            {value ? (<>
                ...
                <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white rounded-lg border-t-1 shadow-md border-gray-200 border p-4 text-center">
                        <h2 className="text-lg font-bold">New Admissions</h2>
