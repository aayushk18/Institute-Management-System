...
const allData = [
    { sno: 1, Roll_no: '101', firstName: 'Aman Kumar', fatherName: 'Rajesh Kumar', StudentClass: '1', section: 'A', active: true },
    { sno: 2, Roll_no: '102', firstName: 'Riya Singh', fatherName: 'Dinesh Singh', StudentClass: '2', section: 'B', active: false },
    { sno: 3, Roll_no: '103', firstName: 'Vikram Das', fatherName: 'Suresh Das', StudentClass: '1', section: 'B', active: true },
    { sno: 4, Roll_no: '104', firstName: 'Sneha Gupta', fatherName: 'Mahesh Gupta', StudentClass: '3', section: 'C', active: true },
                            ...
                            {currentEntries.map((student, index) => (
                                <tr key={student.sno} className="text-center text-black">
                                    ...
                                    <td className="p-2 border-b">
                                        <button onClick={() => navigate(`/admin/student/update-student/${student.firstName}-${student.lastName}-${student.Roll_no}`, { state: { pass: student } })} className="bg-gray-500 hover:bg-gray-600 text-white px-3 py-1 rounded-md">Edit</button>
                                    </td>
                                    <td className="p-2 border-b">
