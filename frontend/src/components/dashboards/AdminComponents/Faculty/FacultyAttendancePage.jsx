...
const FacultyAttendancePage = () => {
  ...
  useEffect(() => {
    ...
    days.forEach(({ dateStr, isSunday }) => {
      initial[dateStr] = isSunday ? 'Sunday' : ''; // Sunday fixed, others blank
    });
...
//             <div
//               key={day.dateStr}
//               className={`p-3  text-center border-gray-300  border ${getColor(attendance[day.dateStr])}`}
//             >
//               <div className="font-semibold">{day.date.getDate()}</div>
//               <div className="text-xs">{attendance[day.dateStr] || 'Not Marked'}</div>
//             </div>
...
//             <th className="border-b-1 p-2 text-white text-left">Date</th>
//             <th className="border-b-1 p-2 text-white text-left">Day</th>
//             <th className="border-b-1 p-2 text-white text-left">Status</th>
//             <th className="border-b-1 p-2 text-white text-left">Set Status</th>
//           </tr>
//         </thead>
//         <tbody>
//           {days.map(({ dateStr, display, weekday, isSunday }) => (
//             <tr key={dateStr} className={isSunday ? 'bg-gray-50' : ''}>
//               <td className="border-b-1 p-2">{display}</td>
//               <td className="border-b-1 p-2">{weekday}</td>
//               <td className="border-b-1 p-2">
//                 <span
//                   className={`px-2 py-1 rounded text-xs font-semibold ${attendance[dateStr] === 'Present'
//                     ? 'bg-green-100 text-green-700'
//                     : attendance[dateStr] === 'Half Day'
