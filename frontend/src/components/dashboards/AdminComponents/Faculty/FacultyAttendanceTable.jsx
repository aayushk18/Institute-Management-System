        ...
        <div>
            <div className="p-6 bg-white rounded shadow-md">
                ...
                <div className="flex flex-wrap items-center justify-between mb-4 space-y-2 sm:space-y-0 sm:flex-nowrap">
                    {/* Dropdown */}
                    <select
                        className="  bg-white  border-1 border-gray-400 p-2 rounded"
                        value={department}
                    ...
                    <div className="flex items-center space-x-2">
                        <input
                            ...
                            className="bg-white border-1 border-gray-500 p-2 rounded"
                            value={search}
                ...
                <div className="overflow-x-auto">
                    ...
                    {department != '' ? (<>
                        ...
                        <div className="flex items-center justify-center w-full h-50">
                            <span className='text-2xl text-gray-700'>Please the Staff Type </span>
                        </div>
