...
const AdminStudentAttendance = () => {
    ...
    const sendAttendance = async () => {
        ...
        await axiosInstance.post('user/admin/students/attendance/update-student-attendance', Data)
    ...
    const getAttendance = async () => {
        ...
        const response = await axiosInstance.post('/user/admin/students/attendance/get-student-attendance', Data)
        ...
        if (data.attendance) {
            ...
            const attendanceObj = data.attendance.reduce((acc, curr) => {
    ...
    return (
        <div className="p-6 max-w-6xl mx-auto bg-white">
            <h1 className="text-2xl font-bold mb-6">{`Student Attendance - ${value.firstName} ${value?.midName} ${value?.lastName}`}</h1>
