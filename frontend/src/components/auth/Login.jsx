...
const Login = () => {
    ...
    const validateForm = () => {
        if (!Form.loginID.trim()) return toast.error("Login ID is required");
            ...
            <div className="max-w-md  w-full bg-white p-8 shadow-lg rounded-xl">
                ...
                <form onSubmit={handleLogin} className="space-y-5" >
                    ...
                    <button disabled={isLoggingIn}
                        ...
                        className="w-full bg-gray-700 text-xl text-white py-2 rounded-md hover:bg-gray-800 transition"
                    >
                        {isLoggingIn ? <>
                            <Loader2 className=" w-full justify-center animate-spin" />
                        </> : 'Login'}
                    </button>
